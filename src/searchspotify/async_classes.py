...
class AlbumTrack:
    ...
    def __init__(self, track_data):
        ...
        :param url: Spotify URL of the track.
        :param name: Name of the track.
        :param artists: List of artists associated with the track.
        :param track_number: Track number in the album.
        :param duration_ms: Duration of the track in milliseconds.
        """
        self.url = track_data.get("external_urls", {}).get("spotify")
...
class Albums:
    ...
    def __init__(self, album_data):
        ...
        :param release_date: Release date of the album.
        :param total_tracks: Total number of tracks in the album.
        :param thumb: URL of the album's thumbnail image.
        :param url: URL of the album's thumbnail image.
        :param label: Record label of the album.
        :param popularity: Popularity score of the album.
        :param tracks: List of AlbumTrack objects representing tracks in the album.
        """
        self.name = album_data.get("name", "Unknown Album")
        self.artists = ", ".join(
...
class PlaylistTrack:
    ...
    def __init__(self, track_data):
        ...
        :param name: Name of the track.
        :param artists: List of artists associated with the track.
        :param album: Name of the album the track belongs to.
        :param release_date: Release date of the track's album.
        :param preview_url: Preview URL of the track.
        :param thumb: URL of the track's thumbnail image.
        :param duration_ms: Duration of the track in milliseconds.
        """
        self.url = track_data.get("external_urls", {}).get("spotify")
        self.name = track_data.get("name")
...
class Playlists:
    ...
    def __init__(self, playlist_data):
        ...
        :param name: Name of the playlist.
        :param description: Description of the playlist.
        :param total_tracks: Total number of tracks in the playlist.
        :param thumb: URL of the playlist's thumbnail image.
        :param tracks: List of PlaylistTrack objects representing tracks in the playlist.
        """
        self.name = playlist_data.get("name", "Unknown Playlist")
        self.description = playlist_data.get("description", "")
        self.total_tracks = playlist_data.get("tracks", {}).get("total", 0)
        self.thumb = playlist_data.get("images", [])[0].get("url")
        self.tracks = [
